...
namespace PricePrediction
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\asus\Desktop\faculta\master_an_1\BigData\laborator7\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=77,NumberOfLeaves=443,FeatureFraction=0.9263952F,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features"}));
